...
{
  $yanzhengyue=obj.value;
  if($yanzhengyue!=1){
   document.getElementById('yuyanzhengma').style.display='none';
   document.getElementById('bal').style.display='none';
  }else
  {
   document.getElementById('yuyanzhengma').style.display='block';
   document.getElementById('bal').style.display='table-row';
  }
...
function checkConsignee(frm)
{
  ...
  if ($('#daigou_id').val() > 0 || $('#daishou_id').val() > 0)
  {
	return true;
  }
