...
function log_account_change($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = 0, $change_desc = '', $change_type = ACT_OTHER)
{
    ...
    if($user_money < 0){
        ...
        if($users){
            ...
            if($users['today_consume_date']<$today_date){
                $sql .=", today_consume_date = ".$today_date.", today_consume = ".abs($user_money).", today_consume_points = 0";
            }else{
    ...
    if($rank_points>0 && $pay_points>0){
        ...
        if($users){
            $today_date = strtotime(date('Y-m-d',time()));
            if($users['today_consume_date']<$today_date){
                $sql .=", today_consume_date = ".$today_date.", today_consume_points = ".$pay_points;
            }else{
