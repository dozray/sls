...
class ucenter extends integrate
{
     ...
     * @return void
     */
    function login($username, $password,$remeber = NULL)
    {
        ...
        if($uid > 0)
        {
            ...
            $this->set_cookie($uname,$remember = NULL);
    ...
    /*添加用户*/
    function add_user($username, $password, $email,$gender=-1,$body=0,$reg_date=0,$md5password='')
    {
        /* 检测用户名 */
