...
?>
  <tr>
    ...
    <td><?php if ($this->_var['user']['user_rank'] == 3): ?>社区网点<?php elseif ($this->_var['user_rankz']): ?>认证用户<?php else: ?>居民用户<?php endif; ?></td>
    <td><?php echo $this->_var['user']['areaname']; ?><?php if ($this->_var['user']['user_rank'] == 3): ?><br><?php echo $this->_var['user']['wangdian']; ?><?php endif; ?></td>
