...
?>
         ...
         <?php if ($this->_var['admin_shops']): ?>
          <tr>
            ...
            <td><select name="admin_id" id="suppliers_id">
        <option value="0"><?php echo $this->_var['lang']['supnopliers_']; ?></option>
        <?php $_from = $this->_var['admin_shops']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
      <option value="<?php echo $this->_var['item']['user_id']; ?>" <?php if ($this->_var['goods']['admin_id'] == $this->_var['item']['user_id']): ?> selected <?php endif; ?>><?php echo $this->_var['item']['name']; ?></option>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </select></td>
          </tr>
         <?php endif; ?>
          ...
          <tr>
            ...
            <td><input type="text" name="chandi" value="<?php echo $this->_var['goods']['chandi']; ?>" />   </td>
          </tr>
          <tr>
            <td class="label">规格：</td>
            <td><input type="text" name="guige" value="<?php echo $this->_var['goods']['guige']; ?>" />   </td>
          </tr>
		   <tr>
            <td class="label">最多购买：</td>
            <td><input type="text" name="max_number" value="<?php if ($this->_var['goods']['max_number']): ?><?php echo $this->_var['goods']['max_number']; ?><?php else: ?>0<?php endif; ?>" size="20" /> 件 <span class="notice-span" >(0件代表不限制)</span></td>
          </tr>
		  <tr>
            <td class="label">代购奖励：</td>
            <td><input type="text" name="dai_percent" value="<?php echo $this->_var['goods']['dai_percent']; ?>" size="20" /> %</td>
          </tr>
		  <tr>
            <td class="label">代收奖励：</td>
            <td><input type="text" name="shou_percent" value="<?php echo $this->_var['goods']['shou_percent']; ?>" size="20" /> %</td>
          </tr>
          <!-- 
