...
?>
  <tr>
    <td class="first-cell" ><a href="privilege.php?act=info&id=<?php echo $this->_var['list']['user_id']; ?>"><?php echo $this->_var['list']['user_name']; ?></a></td>
	 <td align="center"><?php if ($this->_var['list']['role_id'] == 1): ?>供应商<?php endif; ?></td>
    <td align="center"><?php echo $this->_var['list']['areaname']; ?></td>
