...
<?php if ($this->_var['full_page']): ?>
  ...
  <div>
	...
	<input name="tongjitingzi" type="submit" id="btnSubmit5" value="根据社区网点统计报表" class="button" disabled="true" onclick="this.form.target = '_blank'" />
	<input name="tongjihuowu" type="submit" id="btnSubmit6" value="根据商品数量统计报表" class="button" disabled="true" onclick="this.form.target = '_blank'" />
