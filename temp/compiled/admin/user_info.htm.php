...
<table width="100%" >
  ...
  <tr>
    ...
    <td><select name="user_rank">
      <option value="1" <?php if ($this->_var['user']['user_rank'] == 0 && $this->_var['user']['user_rankz'] == 0): ?>selected<?php endif; ?>>居民用户</option>
      <option value="2" <?php if ($this->_var['user']['user_rank'] == 0 && $this->_var['user']['user_rankz'] == 1): ?>selected<?php endif; ?>>认证用户</option>
      <option value="3" <?php if ($this->_var['user']['user_rank'] == 3): ?>selected<?php endif; ?>>社区网点</option>
...
?> -->
                      <option value="<?php echo $this->_var['country']['region_id']; ?>" <?php if ($this->_var['country_id'] == $this->_var['country']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['country']['region_name']; ?></option>
...
?> -->
                      <option value="<?php echo $this->_var['province']['region_id']; ?>" <?php if ($this->_var['province_id'] == $this->_var['province']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['province']['region_name']; ?></option>
                      <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                    </select>
...
?> -->
                      <option value="<?php echo $this->_var['city']['region_id']; ?>" <?php if ($this->_var['city_id'] == $this->_var['city']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['city']['region_name']; ?></option>
                      <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                    </select>
...
?> -->
                      <option value="<?php echo $this->_var['district']['region_id']; ?>" <?php if ($this->_var['district_id'] == $this->_var['district']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['district']['region_name']; ?></option>
                      <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                    </select></td>
  </tr>
  <tr>
