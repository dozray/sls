              ...
              <td bgcolor="#ffffff" align="center">
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  ...
                  <?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="50" height="50"/></a>
                  <?php else: ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="50" height="50" /></a><br />
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a>
                  <?php endif; ?>
...
?>
              ...
              <td align="center" bgcolor="#ffffff">
                ...
                <a href="javascript:;" onclick="red_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>);"> - </a><input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="inputBg" style="text-align:center " onblur="change_price(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>)"/><a href="javascript:;" onclick='add_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>)' >+</a>
                <?php else: ?>
...
document.getElementById('market_amount_desc').innerHTML = result.market_amount_desc;//购物车商品总市价说明
             ...
             <td align="center" bgcolor="#ffffff" id="subtotal_<?php echo $this->_var['goods']['rec_id']; ?>"><?php echo $this->_var['goods']['subtotal']; ?></td>
              <td align="center" bgcolor="#ffffff">
                ...
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_to_collect&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6" style="display:none"><?php echo $this->_var['lang']['drop_to_collect']; ?></a>
                <?php endif; ?>            </td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
  ...
  <?php if ($this->_var['collection_goods'] && 1 == 0): ?>
  <div class="flowBox">
...
?>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('akey', 'goods_l');if (count($_from)):
    foreach ($_from AS $this->_var['akey'] => $this->_var['goods_l']):
?>
            <?php $_from = $this->_var['goods_l']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['goods']):
?>
            <?php if ($this->_var['key'] == 0): ?>
            <tr><td colspan="4" bgcolor="#E8F0D7"><b>供货商：<?php echo $this->_var['goods']['adminname']; ?> <?php echo $this->_var['goods']['areaname']; ?></b></td>
            <td align="right" bgcolor="#E8F0D7">运费：<?php echo $this->_var['total']['shipfees'][$this->_var['akey']]; ?></td></tr>
            <?php endif; ?>
            <tr>
              <td bgcolor="#ffffff">
      ...
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?></td>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['email_address']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['email']); ?></td>
            </tr>
            <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
            <tr>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['detailed_address']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['address']); ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['postalcode']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?></td>
            </tr>
            <?php endif; ?>
            <tr>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo $this->_var['consignee']['tel']; ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['backup_phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?></td>
            </tr>
             <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
            <tr>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['sign_building']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"><?php echo $this->_var['lang']['deliver_goods_time']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['best_time']); ?></td>
            </tr>
            <?php endif; ?>
			<?php if ($this->_var['shouhuo_type'] < 3 && $this->_var['shouhuo_type'] > 0): ?>
			<tr>
              <td bgcolor="#ffffff" width="120" align="right"><b>取货人姓名:</b></td>
              <td bgcolor="#ffffff"><?php echo $this->_var['quhuo_name']; ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"><b>取货人手机号:</b></td>
              <td bgcolor="#ffffff"><?php echo $this->_var['quhuo_tel']; ?></td>
            </tr>
			<tr>
              <td bgcolor="#ffffff" width="120" align="right"><b>取货人地址:</b></td>
              <td bgcolor="#ffffff"><?php echo $this->_var['receiveaddres']; ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"><b>取货最佳时间:</b></td>
              <td bgcolor="#ffffff"><?php echo $this->_var['sendTime']; ?></td>
            </tr>
            <tr>
              <td bgcolor="#ffffff" width="120" align="right"><b>取货人方式:</b></td>
              <td bgcolor="#ffffff"><?php if ($this->_var['quhuo_fangshi'] == 1): ?>自提<?php else: ?>送货<?php endif; ?> </td>
              <td bgcolor="#ffffff" width="120" align="right"> </td>
     ...
     <div class="blank"></div>
    <?php if ($this->_var['total']['real_goods_count'] != 0): ?>
    <div class="flowBox" <?php if ($this->_var['shouhuo_type'] < 3 && $this->_var['shouhuo_type'] > 0): ?> style="display:none;"<?php endif; ?>>
    ...
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="shippingTable">
            ...
            <?php $_from = $this->_var['shipping_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'shipping');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['shipping']):
?>
            <tr>
              <td bgcolor="#ffffff" valign="top"><input name="shipping" type="radio" value="<?php echo $this->_var['shipping']['shipping_id']; ?>" <?php if ($this->_var['order']['shipping_id'] == $this->_var['shipping']['shipping_id'] || $this->_var['key'] == 0): ?>checked="true"<?php endif; ?> supportCod="<?php echo $this->_var['shipping']['support_cod']; ?>" insure="<?php echo $this->_var['shipping']['insure']; ?>" onclick="selectShipping(this)" />
              </td>
...
?>
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input type="radio" name="payment" value="<?php echo $this->_var['payment']['pay_id']; ?>" isCod="<?php echo $this->_var['payment']['is_cod']; ?>" onclick="selectPayment(this)" <?php if ($this->_var['cod_disabled'] && $this->_var['payment']['is_cod'] == "1"): ?>disabled="true"<?php endif; ?>/></td>
    ...
    <?php endif; ?>
    <div class="blank"></div>
          <?php if ($this->_var['pack_list'] && 1 == 0): ?>
          <div class="flowBox">
...
?>
          ...
          <?php if ($this->_var['card_list'] && 1 == 0): ?>
          <div class="flowBox">
...
?>
    ...
    <h6><span><?php echo $this->_var['lang']['other_info']; ?></span></h6>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <?php endif; ?>
            <?php if ($this->_var['allow_use_integral'] && 1 == 0): ?>
            <tr>
            ...
            <?php endif; ?>
            <?php if ($this->_var['allow_use_bonus'] && 1 == 0): ?>
            <tr>
...
?>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
		  ...
		  <div id="yuyanzhengma" style=" margin-left:300px; display:none;">
			 接受验证码的手机号必须则是用户信息里的手机号码，如果您使用余额支付请获取短信验证码：<input id="vdcode" class="text login_from3" type="text" style="width: 50px;  text-transform: uppercase;" name="vdcode"/>
        ...
        <div class="flowBox" style="margin:30px auto 70px auto;">
         <h6 style="text-align:center; height:30px; line-height:30px;"><?php echo $this->_var['lang']['remember_order_number']; ?>: <font style="color:red"><?php echo $this->_var['order']['order_sn']; ?></font></h6>
          <table width="99%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" style="border:1px solid #ddd; margin:20px auto;" >
            <tr>
              <td align="center" bgcolor="#FFFFFF">
              <?php if ($this->_var['order']['shipping_name']): ?><?php echo $this->_var['lang']['select_shipping']; ?>: <strong><?php echo $this->_var['order']['shipping_name']; ?></strong>，
              <?php endif; ?><?php echo $this->_var['lang']['select_payment']; ?>: <strong><?php echo $this->_var['order']['pay_name']; ?></strong>。<?php if ($this->_var['order']['order_amount_formated'] != "￥0.00元"): ?><?php echo $this->_var['lang']['order_amount']; ?>: <strong><?php echo $this->_var['order']['order_amount_formated']; ?></strong><?php endif; ?>
              </td>
            </tr>
            <tr>
...
$(function(){
	$("#getcode").click(function(){
		...
		$.getJSON("/flow.php", {"phone":phone}, function(json){
