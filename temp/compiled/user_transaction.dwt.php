...
<div class="blank"></div><style type="text/css">
.box_1 {border:0px;}
</style>
...
?>
    ...
    <?php endif; ?>
    <?php if ($this->_var['action'] == 'password'): ?>
    <h5><span>密码管理</span></h5>
      <div class="blank"></div>
...
?>
    ...
    <?php endif; ?>
       ...
       <div class="blank"></div>
       <table width="100%" border="1" bordercolor="#E3E3E3" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr align="center">
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['order_number']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['order_addtime']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['order_money']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['order_status']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['handle']; ?></td>
          </tr>
          <?php $_from = $this->_var['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
          <tr>
            <td align="left" bgcolor="#ffffff"><a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="f6"><?php echo $this->_var['item']['order_sn']; ?></a></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['order_time']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['total_fee']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['order_status']; ?></td>
            <td align="left" bgcolor="#ffffff"><font class="f6"><?php echo $this->_var['item']['handler']; ?></font></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
        <div class="blank5"></div>
       ...
       <?php if ($this->_var['action'] == 'dgorder_list'): ?>
       <h5><span>代购订单管理</span></h5>
	   <div>
	   <form name="s" action="" method="get">
	   <input type="hidden" name="act" value="dgorder_list" />
		订单号：<input type="text" name="order_number" value="<?php echo $this->_var['order_number']; ?>" class="search_input" />
		订单状态：<select name="order_status" >
			<option value="-1">请选择...</option>
      <option value="0" <?php if ($this->_var['order_status'] == '0'): ?>selected<?php endif; ?>>待确认</option>
	  <option value="100" <?php if ($this->_var['order_status'] == '100'): ?>selected<?php endif; ?>>待付款</option>
	  <option value="101" <?php if ($this->_var['order_status'] == '101'): ?>selected<?php endif; ?>>待发货</option>
	  <option value="102" <?php if ($this->_var['order_status'] == '102'): ?>selected<?php endif; ?>>已完成</option>
	  <option value="1" <?php if ($this->_var['order_status'] == '1'): ?>selected<?php endif; ?>>付款中</option>
	  <option value="2" <?php if ($this->_var['order_status'] == '2'): ?>selected<?php endif; ?>>取消</option>
	  <option value="3" <?php if ($this->_var['order_status'] == '3'): ?>selected<?php endif; ?>>无效</option>
	  <option value="4" <?php if ($this->_var['order_status'] == '4'): ?>selected<?php endif; ?>>退货</option>
	  <option value="6" <?php if ($this->_var['order_status'] == '6'): ?>selected<?php endif; ?>>部分发货</option>    
		</select>
		购买人账号：<input type="text" name="user_name" value="<?php echo $this->_var['user_name']; ?>" class="search_input" />
		取货人姓名：<input type="text" name="quhuo_name" value="<?php echo $this->_var['quhuo_name']; ?>" class="search_input" />
		取货人手机：<input type="text" name="quhuo_tel" value="<?php echo $this->_var['quhuo_tel']; ?>" class="search_input" />
       ...
       <table width="100%" border="0" cellpadding="5" cellspacing="1" >
          <tr align="center">
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">单号</td>
			<td style="font-weight:bold; color:#000">姓名</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">手机号</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">订单详情</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">价格</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">自提/送货</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">订单状态</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">操作</td>
          </tr>
           <?php $_from = $this->_var['orders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
          <tr>
			...
			<td align="center"><?php echo $this->_var['item']['quhuo_name']; ?></td>
            <td align="center" bgcolor="#ffffff"><?php echo $this->_var['item']['quhuo_tel']; ?></td>
            <td align="center" bgcolor="#ffffff">
            <?php $_from = $this->_var['item']['goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'good');if (count($_from)):
    foreach ($_from AS $this->_var['good']):
?>
            <?php echo $this->_var['good']['goods_name']; ?> * <?php echo $this->_var['good']['goods_number']; ?> <br>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </td>
            <td align="center" bgcolor="#ffffff"><?php echo $this->_var['item']['total_fee']; ?></td>
            <td align="center" bgcolor="#ffffff"><?php if ($this->_var['item']['quhuo_fangshi'] == 1): ?>自提<?php else: ?>送货<?php endif; ?></td>
            <td align="center" bgcolor="#ffffff">
			<?php if ($this->_var['item']['pay_status'] != 2): ?>未付款<?php elseif ($this->_var['item']['dai_status'] == 1): ?>已到货<?php elseif ($this->_var['item']['dai_status'] == 2): ?>已完成<?php else: ?><?php echo $this->_var['item']['shipping_status_name']; ?><?php endif; ?>
			</td>
            <td align="center">
            <?php if ($this->_var['item']['orderstatus'] > 4): ?>
            <a href="/user.php?act=message_list&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="blue">退货</a>
            <?php endif; ?>
            </td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       ...
       <?php if ($this->_var['action'] == 'dsorder_list'): ?>
       <h5><span>代收订单管理</span></h5>
	   <div>
	   <form name="s" action="" method="get">
	   <input type="hidden" name="act" value="dsorder_list" />
		订单号：<input type="text" name="order_number" value="<?php echo $this->_var['order_number']; ?>" class="search_input" />
		订单状态：<select name="order_status" >
			<option value="-1">请选择...</option>
      <option value="0" <?php if ($this->_var['order_status'] == '0'): ?>selected<?php endif; ?>>待确认</option>
	  ...
	  <option value="6" <?php if ($this->_var['order_status'] == '6'): ?>selected<?php endif; ?>>部分发货</option>    
       ...
       <table width="100%" border="0" cellpadding="5" cellspacing="1" class="ordertable">
          <tr align="center">
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">单号</td>
			<td style="font-weight:bold; color:#000">姓名</td>
            <td style="font-weight:bold; color:#000" bgcolor="#ffffff">手机号</td>
...
?>
            ...
            <td align="center" bgcolor="#ffffff"><?php echo $this->_var['item']['total_fee']; ?></td>
            <td align="center" bgcolor="#ffffff"><?php if ($this->_var['item']['quhuo_fangshi'] == 1): ?>自提 <?php echo $this->_var['item']['quhuo_ma']; ?><?php else: ?>送货<?php endif; ?></td>
            <td align="center" bgcolor="#ffffff">
            <?php if ($this->_var['item']['pay_status'] != 2): ?>未付款<?php elseif ($this->_var['item']['dai_status'] == 1): ?>已到货<?php elseif ($this->_var['item']['dai_status'] == 2): ?>已完成<?php else: ?><?php echo $this->_var['item']['shipping_status_name']; ?><?php endif; ?>
			</td>
            <td align="center">
            <?php if ($this->_var['item']['pay_status'] == 2): ?>
            	<?php if ($this->_var['item']['orderstatus'] != 4): ?>
	            	<a href="/user.php?act=message_list&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="blue">退货</a>
	            	<?php if ($this->_var['item']['shipping_status'] > 0): ?>
	            	<?php if ($this->_var['item']['dai_status'] == 0): ?>
	            		<a href="/user.php?act=affirm_daohuo&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="blue"  onclick="if (!confirm('确认更改订单为已到货吗？')) return false;">已到货</a>
	            	<?php elseif ($this->_var['item']['dai_status'] == 1): ?>
					
					<?php if ($this->_var['item']['quhuo_fangshi'] == 1): ?>
					
					 <form  action="user.php?act=affirm_shouhuo&order_id=<?php echo $this->_var['item']['order_id']; ?>" method="post">
					 <input type="text" id="quhuo_ma" name="quhuo_ma"  class="search_input"/>
					<a href="/" class="blue" ><input type="submit" />提货码验证</a>
					</form>
					<?php else: ?>
					
	            		<a href="/user.php?act=affirm_shouhuo&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="blue"  onclick="if (!confirm('确认更改订单为已<?php if ($this->_var['item']['quhuo_fangshi'] != 1): ?>送货<?php endif; ?>吗？')) return false;">已送货</a><?php endif; ?>
...
?>
        ...
        <h5><span><?php if ($this->_var['action'] == "account_log" || $this->_var['action'] == "account_deposit"): ?>资金充值<?php endif; ?>
        <?php if ($this->_var['action'] == "account_detail"): ?>资金明细<?php endif; ?>
        </span></h5>
        <?php if ($this->_var['action'] == "account_log" || $this->_var['action'] == "account_deposit"): ?>
        <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td align="right" bgcolor="#ffffff"><a href="user.php?act=account_deposit" class="f6"><?php echo $this->_var['lang']['surplus_type_0']; ?></a> | <a href="user.php?act=account_log" class="f6"><?php echo $this->_var['lang']['view_application']; ?></a> </td>
          </tr>
        </table>
        <?php endif; ?>
        <?php endif; ?>
...
?>
       ...
       <?php if ($this->_var['action'] == "account_detail"): ?>
        <table width="100%" border="1" bordercolor="#E3E3E3" style="margin-top:10px; " cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr align="center">
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['process_time']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['surplus_pro_type']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['money']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['change_desc']; ?></td>
          </tr>
          <?php $_from = $this->_var['account_log']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
          <tr>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['change_time']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['type']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['amount']; ?></td>
            <td align="left" bgcolor="#ffffff" title="<?php echo $this->_var['item']['change_desc']; ?>">&nbsp;&nbsp;<?php echo $this->_var['item']['short_change_desc']; ?></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <tr>
        ...
        <table width="100%" border="1" bordercolor="#E3E3E3" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr align="center">
            <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['process_time']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['surplus_pro_type']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['money']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['admin_notic']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['is_paid']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['handle']; ?></td>
          </tr>
          <?php $_from = $this->_var['account_log']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
          <tr>
            ...
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['pay_status']; ?></td>
            <td align="left" bgcolor="#ffffff"><?php echo $this->_var['item']['handle']; ?>
            ...
            <form action="user.php" method="post" name="theForm" onsubmit="return checkConsignee(this)">
              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
                  ...
                  <td colspan="3" align="left" bgcolor="#ffffff"><select style="display:none" name="country" id="selCountries_<?php echo $this->_var['sn']; ?>" onchange="region.changed(this, 1, 'selProvinces_<?php echo $this->_var['sn']; ?>')">
...
?>
				...
				<?php if ($this->_var['specail_rank'] == 1): ?>
				<tr>
                  <td align="right" bgcolor="#ffffff">小区名称：</td>
                  <td colspan="3" align="left" bgcolor="#ffffff">
				  <input name="name" type="text" class="inputBg" id="name_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['name']); ?>" />
