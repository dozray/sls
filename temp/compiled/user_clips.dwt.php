     ...
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
         ...
         <?php if ($this->_var['action'] == 'default'): ?>
         	<table width="100%" >
         		<tr>
         			...
         			<font class="f5">用户：<b class="f4"><?php echo $this->_var['info']['username']; ?></b> 
					用户等级：<?php if ($this->_var['info']['user_rank'] == 3): ?>社区网点<?php elseif ($this->_var['info']['user_rankz']): ?>认证用户<?php else: ?>居民用户<?php endif; ?>
					</font></td>
         		</tr>
         		<tr>
         			<td width="100" height="30">今日余额：</td><td width="150"><?php echo $this->_var['info']['surplus']; ?></td>
         			<td width="100">余额积分：</td><td><?php echo $this->_var['info']['today_money_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30">今日消费：</td><td width="150">￥<?php echo $this->_var['info']['today_consume']; ?>元</td>
         			<td width="100">消费积分：</td><td><?php echo $this->_var['info']['today_consume_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30">今日自提：</td><td width="150"><?php if ($this->_var['info']['today_ziti']): ?>是<?php else: ?>否<?php endif; ?></td>
         			<td width="100">自提积分：</td><td><?php echo $this->_var['info']['today_ziti_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30"> </td><td width="150"></td>
         			<td width="100">今日合计积分：</td><td><?php echo $this->_var['info']['today_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30"> </td><td width="150"></td>
         			<td width="100">总积分：</td><td><?php echo $this->_var['info']['total_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30"> </td><td width="150"></td>
         			<td width="100">已使用积分：</td><td><?php echo $this->_var['info']['consume_points']; ?></td>
         		</tr>
         		<tr>
         			<td width="100" height="30"> </td><td width="150"></td>
         			<td width="100">剩余积分：</td><td><?php echo $this->_var['info']['pay_points']; ?></td>
         		</tr>
         	</table>
         ...
         <div style="display:none">
          ...
          <?php echo $this->_var['rank_name']; ?>  <br />
